...
" > $baseSourcePath/hbv_uq_cm2_sc_q_7_d_5_p_3.cmd

    #execute batch file
    sbatch $baseSourcePath/hbv_uq_cm2_sc_q_7_d_5_p_3.cmd

}

model="hbvsask"
opt_add="--store_gpce_surrogate_in_stat_dict --parallel_statistics --compute_Sobol_t --compute_Sobol_m --sampleFromStandardDist"  # "--disable_statistics" "--sc_poly_normed"
nodes=4
tasks_per_node=22
low_time="2:30:00"
mid_time="2:00:00"
