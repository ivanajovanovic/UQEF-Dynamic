...
echo "---- start HBV sim: \`date\`"
    ...
    mpiexec -n \$SLURM_NTASKS /dss/dsshome1/lxc0C/ga45met2/.conda/envs/$conda_env/bin/python $baseSourcePath/uqef_dynamic/scientific_pipelines/uq_simulation_uqsim.py \
                            ...
                            --config_file $baseSourcePath/data/configurations/configuration_hbv_7D_three_years_Oldman.json \
                            --model "$model" \
                            --uncertain "$uncertain" \
...
" > $baseSourcePath/hbv_mc_7d_oldman_2004_2007.cmd

    #execute batch file
    sbatch $baseSourcePath/hbv_mc_7d_oldman_2004_2007.cmd
