...
echo "---- start HBV sim: \`date\`"
    ...
    mpiexec -n \$SLURM_NTASKS /dss/dsshome1/lxc0C/ga45met2/.conda/envs/$conda_env/bin/python $baseSourcePath/uqef_dynamic/scientific_pipelines/uq_simulation_uqsim.py \
                            ...
                            --config_file $baseSourcePath/data/configurations/configuration_hbv_10D_2005_2006.json \
                            --model "$model" \
                            --uncertain "$uncertain" \
...
" > $baseSourcePath/hbv_sc_10d_p4_l6_oldman_2005_2006.cmd

    #execute batch file
    sbatch $baseSourcePath/hbv_sc_10d_p4_l6_oldman_2005_2006.cmd
