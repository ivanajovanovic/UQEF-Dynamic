...
echo "---- start HBV sim: \`date\`"
    ...
    mpiexec -n \$SLURM_NTASKS python $baseSourcePath/uq_simulation_uqsim.py \
                            ...
                            --config_file $baseSourcePath/configurations/configuration_hbv_10D.json \
                            --model "$model" \
                            --uncertain "$uncertain" \
...
" > $baseSourcePath/hbv_uq_cm2_saltelli_10000_sliding_window_gof.cmd

    #execute batch file
    sbatch $baseSourcePath/hbv_uq_cm2_saltelli_10000_sliding_window_gof.cmd

}

model="hbvsask"
opt_add="--parallel_statistics --compute_Sobol_t --compute_Sobol_m --sampleFromStandardDist"  # "--disable_statistics"
nodes=4
tasks_per_node=22
low_time="2:30:00"
mid_time="10:00:00"
...
parameters_file="/dss/dsshome1/lxc0C/ga45met2/Repositories/sparse_grid_nodes_weights/KPU_d6_l10.asc"
parameters_setup_file="/dss/dsshome1/lxc0C/ga45met2/Repositories/UQEF-Dynamic/configurations/KPU_HBV_d6.json"
