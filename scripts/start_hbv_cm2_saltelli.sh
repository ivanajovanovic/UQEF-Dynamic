...
" > $baseSourcePath/hbv_uq_saltelli_lhs_20000_oldman_2007.cmd

    #execute batch file
    sbatch $baseSourcePath/hbv_uq_saltelli_lhs_20000_oldman_2007.cmd

}

model="hbvsask"
opt_add="--parallel_statistics --sampleFromStandardDist --compute_Sobol_m --compute_Sobol_t --instantly_save_results_for_each_time_step --sc_poly_normed --store_gpce_surrogate_in_stat_dict" #--save_all_simulations --read_nodes_from_file
nodes=4
