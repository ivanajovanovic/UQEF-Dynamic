...
" > $baseSourcePath/hbv_uq_sc_p5_l7_ct07_oldman_2006_2007.cmd

    #execute batch file
    sbatch $baseSourcePath/hbv_uq_sc_p5_l7_ct07_oldman_2006_2007.cmd

}

model="hbvsask"
opt_add="--read_nodes_from_file --parallel_statistics --save_all_simulations --sampleFromStandardDist --compute_Sobol_m --compute_Sobol_t --sc_poly_normed --store_gpce_surrogate_in_stat_dict --save_all_simulations" # --instantly_save_results_for_each_time_step
nodes=4
