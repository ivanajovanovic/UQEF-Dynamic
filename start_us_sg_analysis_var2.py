...
if __name__ == "__main__":
    ...
    # TODO Big question about norm_spatiallyAdaptive and modified_basis!!!
    # TODO Seeems as modified_basis=True and boundary_points=True do not work together
    ######Ishigami Var 2&4#######
    # list_of_dict_run_setups = [
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var2_gpce_kpu_p9_l16_adaptive",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    #      "modified_basis": False, "boundary_points": False, "spatiallyAdaptive": True,
    #      "norm_spatiallyAdaptive": 2, "rebalancing": True
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None, "current_output_folder": "var2_gpce_kpu_p9_l16_adaptive_boundary",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10**-5,
    ...
    #      "norm_spatiallyAdaptive":2, "rebalancing": True
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None, "current_output_folder": "var2_gpce_kpu_p9_l16_adaptive_modified",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    ...
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var2_gpce_kpu_p9_l16_nonadaptive",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    ...
    #      "norm_spatiallyAdaptive": 2, "rebalancing": True
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None, "current_output_folder": "var2_gpce_kpu_p9_l16_nonadaptive_boundary",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    ...
    #      "norm_spatiallyAdaptive": 2, "rebalancing": True
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None, "current_output_folder": "var2_gpce_kpu_p9_l16_nonadaptive_modified",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    ...
    # list_of_dict_run_setups = [
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var4_sg_adaptive_eval103_tol105_boundary_adaptive",
    #      "variant": 4, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 1000, "tolerance": 10 ** -5,
    #      "modified_basis": False, "boundary_points": True, "spatiallyAdaptive": True,
    #      "norm_spatiallyAdaptive": 2, "rebalancing": True
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var4_sg_adaptive_eval104_tol105_boundary_adaptive",
    #      "variant": 4, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    #      "modified_basis": False, "boundary_points": True, "spatiallyAdaptive": True,
    ...
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var4_sg_adaptive_eval105_tol105_boundary_adaptive",
    #      "variant": 4, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 100000, "tolerance": 10 ** -5,
    #      "modified_basis": False, "boundary_points": True, "spatiallyAdaptive": True,
    #      "norm_spatiallyAdaptive": 2, "rebalancing": True
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var4_sg_adaptive_eval104_tol105_boundary_nonadaptive",
    #      "variant": 4, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    #      "modified_basis": False, "boundary_points": True, "spatiallyAdaptive": False,
    ...
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var4_sg_adaptive_eval104_tol105_modified_nonadaptive",
    #      "variant": 4, "quadrature_rule": "g", "q_order": 16, "p_order": 9, "sparse_quadrature": True,
    #      "read_nodes_from_file": True, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    #      "modified_basis": True, "boundary_points": False, "spatiallyAdaptive": False,
    ...
    # list_of_dict_run_setups = [
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var2_gpce_gl_p10_q11_adaptive_modified",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 11, "p_order": 10, "sparse_quadrature": False,
    #      "read_nodes_from_file": False, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    #      "modified_basis": True, "boundary_points": True, "spatiallyAdaptive": True,
    #      "norm_spatiallyAdaptive": 2, "rebalancing": True
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var2_gpce_gl_p10_q11_adaptive_nonmodified",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 11, "p_order": 10, "sparse_quadrature": False,
    #      "read_nodes_from_file": False, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    #      "modified_basis": False, "boundary_points": True, "spatiallyAdaptive": True,
    ...
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var2_gpce_gl_p10_q11_nonadaptive_modified",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 11, "p_order": 10, "sparse_quadrature": False,
    #      "read_nodes_from_file": False, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    #      "modified_basis": True, "boundary_points": True, "spatiallyAdaptive": False,
    #      "norm_spatiallyAdaptive": 2, "rebalancing": True
    #      },
    #     {"model": "ishigami", "list_of_function_ids": None,
    #      "current_output_folder": "var2_gpce_gl_p10_q11_nonadaptive_nonmodified",
    #      "variant": 2, "quadrature_rule": "g", "q_order": 11, "p_order": 10, "sparse_quadrature": False,
    #      "read_nodes_from_file": False, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 3,
    #      "max_evals": 10000, "tolerance": 10 ** -5,
    #      "modified_basis": False, "boundary_points": True, "spatiallyAdaptive": False,
    ...
    list_of_dict_run_setups = [
        {"model": "corner_peak", "list_of_function_ids": [1, ],
         "current_output_folder": "var2_gpce_gl_p9_q9_max103_lmax2_adaptive",
    ...
    #  },
        ...
        #
        # {"model": "corner_peak", "list_of_function_ids": [1, ],
        #  "current_output_folder": "var2_gpce_gl_p9_q9_max105_lmax2_adaptive",
        #  "variant": 2, "quadrature_rule": "g", "q_order": 9, "p_order": 9, "sparse_quadrature": False,
        #  "read_nodes_from_file": False, 'l': 16, "gridName": "Trapezoidal", "lmin": 1, "lmax": 2,
        #  "max_evals": 100000, "tolerance": 10 ** -6,
        #  "modified_basis": False, "boundary_points": False, "spatiallyAdaptive": True,
