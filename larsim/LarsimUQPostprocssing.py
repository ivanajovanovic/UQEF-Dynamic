...
def _calcStatisticsForSaltelli(df_all_simulations, simulationNodes, numEvaluations, order, regression):
    ...
    for key,val_indices in groups.items():
        ...
        #Abfluss[key]["E"] = np.mean(extended_standard_discharge_values, 0)
        ...
        #Abfluss[key]["StdDev"] = np.std(extended_standard_discharge_values, 0, ddof=1)
        ...
        #Abfluss[key]["Sobol_m"] = saltelliSobolIndicesHelpingFunctions._Sens_m_sample_3(discharge_values_saltelli, dim, numEvaluations)
