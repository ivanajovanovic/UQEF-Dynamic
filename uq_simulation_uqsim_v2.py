...
if local_debugging:
    ...
    uqsim.args.config_file = "/dss/dsshome1/lxc0C/ga45met2/Repositories/Larsim-UQ/configuration_larsim_uqsim_cm2_v2.json" #"configuration_larsim_uqsim.json"
...
outputResultDir = os.path.abspath(os.path.join(uqsim.args.outputResultDir, 'run_6_v2'))
