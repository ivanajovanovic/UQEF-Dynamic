"""
All the code comes from pyapprox package published by sandialabs
https://github.com/sandialabs/pyapprox/blob/master/pyapprox/analysis/sensitivity_analysis.py
"""
import numpy as np
...
def morris_sensitivities(fun, variable, ntrajectories,
    ...
    values = fun(samples)  # TODO this is what I need to write!
    ...
    return mu, sigma, samples, values
